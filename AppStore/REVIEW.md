...
MD Shift is a scheduling tool — not emergency dispatch. Use your hospital’s normal channels for clinical emergencies.
...
| Field | Value |
| --- | --- |
| Sign-in required? | Yes — use Sign in with Apple, Google, or email |
